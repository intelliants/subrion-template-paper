...
<div class="a-item -{$listing.status}{if $listing.sponsored} a-item--sponsored{/if}{if $listing.featured} a-item--featured{/if}" id="article-{$listing.id}">
    ...
    <div class="a-item__labels">
        ...
        <span><span class="fa fa-eye"></span> {$listing.views_num} {if 1 == $listing.views_num}{lang key='view'}{else}{lang key='views'}{/if}</span>
    </div>
